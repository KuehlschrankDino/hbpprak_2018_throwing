...
def grab_image (t, camera, visualizer, visualizer_hand, topic):
    ...
    pub.publish(1)
    pub = rospy.Publisher('/cY_hand', Int32, queue_size=10)
    pub.publish(1)
    pub = rospy.Publisher('/cX', Int32, queue_size=10)
    pub.publish(1)
    pub = rospy.Publisher('/cY', Int32, queue_size=10)
    pub.publish(1)
    if image_msg is not None:
        ...
        self.pub = rospy.Publisher('/cX_hand', Int32, queue_size=10)
        self.pub.publish(cX_hand)
        self.pub2 = rospy.Publisher('/cY_hand', Int32, queue_size=10)
        self.pub2.publish(cY_hand)
        self.pub3 = rospy.Publisher('/cX', Int32, queue_size=10)
        self.pub3.publish(cX)
        self.pub4 = rospy.Publisher('/cY', Int32, queue_size=10)
        self.pub4.publish(cY)
